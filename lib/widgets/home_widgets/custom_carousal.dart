...
import 'package:laxmi/utils/quotes.dart';
import 'package:laxmi/widgets/home_widgets/safewebview.dart';
              ...
              onTap: () {
                if (index == 0) {
                  navigateToRoute(
                      ...
                      SafeWebView(
                          url:
                          "https://thetempest.co/2016/11/17/culture-taste/culture/12-badass-indian-women-you-need-to-know-about/"));
                } else if (index == 1) {
                  navigateToRoute(
                      context,
                      SafeWebView(

...
class Child_Home_Screen extends StatefulWidget {
  ...
  @override
  State<Child_Home_Screen> createState() => _Child_Home_Screentate();
}

 class _Child_Home_Screentate extends State<Child_Home_Screen> {
...
//     Utils.showToastMsg( "no number exist please add a number");
//   } else {
//     for (var i = 0; i < contactList.length; i++) {
//       Telephony.backgroundInstance
//           .sendSms(to: contactList[i].number, message: messageBody)
//           .then((value) {
//         Utils.showToastMsg("message send");
//       });
//     }
//   }
// }
